...
export const BADGE_TO_ROLE_REGEX: { pattern: RegExp, role: BadgeRole }[] = [
    { pattern: /translator/i, role: BadgeRole.Translator },
    { pattern: /retired-staff/i, role: BadgeRole.RetiredStaff },
    { pattern: /occifer/i, role: BadgeRole.Occifer },
    { pattern: /mega-noder/i, role: BadgeRole.MegaNoder },
    { pattern: /pro-noder/i, role: BadgeRole.ProNoder },
    { pattern: /master-noder/i, role: BadgeRole.MasterNoder },
    { pattern: /legendary-noder/i, role: BadgeRole.LegendaryNoder },
    { pattern: /featured-lvl1/i, role: BadgeRole.FeaturedLvl1 },
    { pattern: /featured-lvl2/i, role: BadgeRole.FeaturedLvl2 },
    { pattern: /featured-lvl3/i, role: BadgeRole.FeaturedLvl3 },
    { pattern: /featured-lvl4/i, role: BadgeRole.FeaturedLvl4 },
    { pattern: /uc-winner-lvl1/i, role: BadgeRole.UCWinnerLvl1 },
    { pattern: /uc-winner-lvl2/i, role: BadgeRole.UCWinnerLvl2 },
    { pattern: /uc-winner-lvl3/i, role: BadgeRole.UCWinnerLvl3 },
    { pattern: /uc-winner-lvl4/i, role: BadgeRole.UCWinnerLvl4 },
    { pattern: /uc-voter/i, role: BadgeRole.UCVoter },
    { pattern: /crusader/i, role: BadgeRole.Crusader },
    { pattern: /halloween-2018-winner/i, role: BadgeRole.Halloween2018Winner },
    { pattern: /halloween-2020-winner/i, role: BadgeRole.Halloween2020Winner },
    { pattern: /halloween-2021-winner/i, role: BadgeRole.Halloween2021Winner },
    { pattern: /halloween-2022-winner/i, role: BadgeRole.Halloween2022Winner },
    { pattern: /christmas-2020-winner/i, role: BadgeRole.Christmas2020Winner },
    { pattern: /christmas-2021-winner/i, role: BadgeRole.Christmas2021Winner },
    { pattern: /christmas-2022-winner/i, role: BadgeRole.MerryMadnessWinner },
    { pattern: /treasure-trove-winner/i, role: BadgeRole.TreasureTroveWinner },
    { pattern: /stick-idol-winner/i, role: BadgeRole.StickIdolWinner },
];
